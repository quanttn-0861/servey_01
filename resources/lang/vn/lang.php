...
return [
    ...
    'about_us_content' => 'Sun* Việt Nam là công ty Nhật Bản về lĩnh vực công nghệ thông tin chuyên thiết kế, phát triển ứng dụng, trò chơi chạy trên điện thoại thông minh, nền tảng mạng xã hội, sản xuất và phát triển ứng dụng website.',
    ...
    */
    ...
    'warning_close_survey_to_delete' => 'Khảo sát đang mở, bạn phải đóng khảo sát trước khi xóa!',
    ...
    */
    ...
    'confirm_delete_user' => 'Bạn có chắc chắn muốn xóa user này không?',
    ...
    'delete_user_error' => 'Xóa user thất bại! Hãy thử lại!',
    'admin' => 'Quản trị',
    'user' => 'Thành viên',
    'status' => 'Trạng Thái',
    'active' => 'Active',
